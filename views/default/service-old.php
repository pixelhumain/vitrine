			...
			<div class="row">
				<div class="col-md-5">
		            <div align="right" id="adhesion">   
						<h2>J'adhère</h2>
						<p><strong>Pour devenir membre d’OPEN-ATLAS,</strong> l’association porteuse du projet Pixel Humain.<br></p>
				...
				<div class="col-md-5">
		           <div id="participe" >   
                    	<h2>Je participe</h2>
						<p>Vous êtes artiste, un particulier, une association, une entreprise, une collectivité, <strong>venez mettre votre grain de sel dans</strong> l’élaboration du Pixel Humain, devenez Pixel actif !!!</p>
