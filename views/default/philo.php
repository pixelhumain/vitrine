...
<section id="philosophie" class="center section with-arrow">
	<!-- SECTION TITLE -->
				...
				<ul class="slides" style="width: 200%; transition-duration: 0s; transform: translate3d(-751px, 0px, 0px);">
					<li style="float: left; display: block;">
						<div class="gallery-item">
							<a class="fancybox" data-fancybox-group="group1" href="<?php echo $this->module->assetsUrl; ?>/images/gallery/AFF_OPENSOURCE.jpg">
								
								<img alt="Image gallery" src="<?php echo $this->module->assetsUrl; ?>/images/gallery/AFF_OPENSOURCE.jpg" draggable="false">
							</a>
						</div>
						<div class="gallery-item">
